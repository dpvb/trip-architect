            ...
            <main className="w-2/5 mx-auto mt-20 pb-20">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="bg-gray-900 p-2 rounded-md">
                        ...
                        <p className="paragraph-content"><span className="font-bold">User Response: </span>User Response: Jessica responds stating that she prefers cycling and would love to attend any local festivals.</p>
